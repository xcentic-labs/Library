          ...
          item: [
            {
              ...
              route: "/counselling/addcounselling",
              parentId: 6,
            },
            {
              id: 9,
              ...
              route: "/counselling/all",
              parentId: 6,
            },
            {
              id: 12,
              name: "Pending Counselling",
              icon: "fas fa-calendar-alt",
              route: "/counselling/pending",
              parentId: 6,
            },
          ],
        },
          ...
          item: [
            {
              ...
              name: "Counselling",
              icon: "fas fa-user-graduate",
              route: "/counselling/bookcounselling",
              parentId: 7,
            },
            {
              id: 11,
              name: "Upcomming",
              icon: "fas fa-calendar-alt",
              route: "/counselling/upcommingcounselling",
              parentId: 7,
            },
          ],
        },
