                        ...
                        (
                            <>
                                ...
                                <div className="mt-6">
                                    ...
                                    <table className="min-w-full max-w-2xl mx-auto border border-gray-300 shadow-md rounded-lg overflow-hidden text-center bg-white mb-10">
