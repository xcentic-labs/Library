...
import getUnSubscribedUser from "./Controller/getunsuscriberuser";

export default function UnSubscribedUser() {
    const { data , isloading ,redirect } = getUnSubscribedUser()
    return (
